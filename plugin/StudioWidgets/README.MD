> Forked from [RenanMsV/StudioWidgets](https://github.com/RenanMsV/StudioWidgets).
>
> This is a library of GUI widgets for Roblox Studio Plugins that builds and improves upon Roblox's official (archived and outdated) StudioWidgets repository.
>
> I've made some very small modifications to suit the plugin's needs, but the vast majority of the code is unchanged.
>
> Please check the original repository out! It's such a great resource!
...
- [Coding conventions](#coding-conventions)
  ...
  - [Bringing the project into studio](#bringing-the-project-into-studio)
- [License](#license)
